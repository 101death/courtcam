#!/bin/bash
# Tennis Court Detection System - Raspberry Pi Dependency Installer
# This script installs all required dependencies for the tennis court detection system on Raspberry Pi
...
echo -e "${GREEN}Tennis Court Detection System - Raspberry Pi Installer${NC}"
